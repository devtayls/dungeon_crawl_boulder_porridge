defmodule DungeonCrawl.CLI.Main do
  ...
  defp welcome_message do
    Shell.info("~~~ Dungeon Crawl: Boulder Porridge ~~~")
    Shell.info("You awake in a porridge, full of monsters")

    Shell.info(
      "You need to grow strong, fight monsters, do algebra and find the fix. In that order."
    )
  end
